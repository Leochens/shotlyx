		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								Videos you create are free for personal and commercial use
								with no watermarks or content-use restrictions from Shotlyx
							</li>
							<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from Shotlyx</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use Shotlyx</h2>
				<p>
					Your exported videos are yours to use for personal, educational, or
					commercial purposes. You can:
				</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use Shotlyx for client work and paid projects</li>
					<li>Share and distribute videos created with Shotlyx</li>
					<li>Modify and distribute the Shotlyx software under AGPL-3.0</li>
				</ul>
				<p>
					You&apos;re responsible for how you use Shotlyx and the content you
					create. Don&apos;t use it for anything illegal in your jurisdiction.
					Closed-source commercial products, white-label offerings, hosted SaaS,
					or enterprise deployments that do not follow AGPL-3.0 need a separate
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use Shotlyx without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Shotlyx does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because Shotlyx is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host Shotlyx on your own servers</li>
					<li>Modify the software to suit your needs</li>
					<li>Contribute improvements back to the community</li>
				</ul>
				<p>
					Source and license context is documented on the Foundation page and
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Shotlyx is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update Shotlyx and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>Major changes will be discussed with the community</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">Stopping Use</h2>
				<p>You can stop using Shotlyx at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
