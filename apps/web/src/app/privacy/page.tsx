	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								Shotlyx does not currently require an account or login
							</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Shotlyx does not currently offer user accounts, login, or Google
					sign-in.
				</p>
				<p>
			...
			<section className="flex flex-col gap-3">
				...
				<p>Shotlyx integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					<li>No account is required to use Shotlyx today</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					Shotlyx is completely open source. You can review our code, see
