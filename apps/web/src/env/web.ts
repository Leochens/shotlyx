...
const webEnvSchema = z
	.object({
		...
		AGENT_VISION_KEY: z.string().optional(),
		AGENT_VISION_MODEL: z.string().optional(),
		AGENT_VISION_HOST: z.string().url().optional(),
		AGENT_VISION_PROVIDER: z.string().optional(),
		AGENT_VISION_STRUCTURED_OUTPUT_MODE: z.string().optional(),
