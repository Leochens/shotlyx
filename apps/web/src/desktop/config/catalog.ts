...
export const DESKTOP_API_GROUPS: DesktopApiGroup[] = [
	...
	},
	{
		...
		purpose:
			"Analyzes imported images or videos with MiniMax M3 for visual verification, video understanding, and editing suggestions.",
		...
		fields: [
			{
				...
				placeholder: "openai-compatible",
				help: "MiniMax M3 uses the OpenAI-compatible chat completions format.",
				applyUrl: "https://platform.minimaxi.com/subscribe/token-plan",
				docsUrl: "https://platform.minimax.io/docs/api-reference/text-openai-api",
			},
			{
				key: "AGENT_VISION_KEY",
				label: "MiniMax M3 API key",
				env: "AGENT_VISION_KEY",
				secret: true,
				placeholder: "sk-cp-...",
				help: "Dedicated MiniMax Token Plan subscription key used for visual analysis and video understanding.",
				applyUrl: "https://platform.minimaxi.com/subscribe/token-plan",
			},
			{
				...
				applyUrl: "https://www.minimax.io/models/text/m3",
			},
			{
				...
				help: "MiniMax Token Plan OpenAI-compatible API base URL.",
				applyUrl: "https://platform.minimaxi.com/docs/token-plan/other-tools",
			},
		],
	},
	{
