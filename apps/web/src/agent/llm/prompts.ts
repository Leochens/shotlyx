...
- Use subtitles_cut_filler_words when the user asks to remove filler words, breath sounds, redundant breath openings, 口气词, 气声, 气口, 口头禅, or 一键剪气口 from the global transcript. If a project-level global transcript does not exist yet, first call subtitles_generate_from_video, then call subtitles_cut_filler_words. This tool directly edits the timeline and keeps the global transcript in sync.
