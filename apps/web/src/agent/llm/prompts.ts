...
- Prefer shotlyx_generate_hyperframes_overlay when generation quality, visual consistency, template choice, title/callout/arrow/circle/box/caption-emphasis polish, or a more video-designed look matters more than arbitrary Remotion component flexibility. Call shotlyx_list_hyperframes_templates first if the user asks to choose a style or compare template options.
